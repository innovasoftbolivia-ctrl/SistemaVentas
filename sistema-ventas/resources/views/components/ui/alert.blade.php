...
@php
    ...
    $icons = [
        'success' => '<svg aria-hidden="true" class="fill-current" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        'error' => '<svg aria-hidden="true" class="fill-current" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        'warning' => '<svg aria-hidden="true" class="fill-current" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        'info' => '<svg aria-hidden="true" class="fill-current" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<div class="rounded-xl border p-4 {{ $containerClass }}">
    <div class="flex items-start gap-3">
        ...
        <div class="flex-1">
            {{-- El título del aviso no es un encabezado de documento: es el
                 asunto de un mensaje pasajero. Como <p> no entra en el índice
                 de encabezados y evita el salto h1 -> h4. --}}
            @if($title)
                <p class="mb-1 text-sm font-semibold text-gray-800 dark:text-white/90">
                    {{ $title }}
                </p>
            @endif
