        ...
        <div class="relative flex h-screen w-full flex-col justify-center sm:p-0 lg:flex-row dark:bg-gray-900">
                ...
                <div class="mx-auto flex w-full max-w-md flex-1 flex-col justify-center">
                    <div class="mb-5 sm:mb-8">
                        ...
                        <p class="text-sm text-gray-500 dark:text-gray-400">
                            Usa la cuenta que te asignó el administrador del negocio.
                        </p>
                    </div>

                    @if ($errors->any())
                        <div class="mb-5">
                            <x-ui.alert variant="error" title="No se pudo ingresar"
                                :message="$errors->first('usuario') ?: $errors->first()" />
                        </div>
                    @endif
                            ...
                            <div>
                                ...
                                <div x-data="{ visible: false }" class="relative">
                                    ...
                                    <span @click="visible = !visible"
                                        ...
                                        <svg aria-hidden="true" x-show="!visible" class="fill-current" width="20" height="20"
            ...
            <div class="fixed right-6 bottom-6 z-50">
                <button type="button"
                    ...
                    <svg aria-hidden="true" class="hidden fill-current dark:block" width="20" height="20" viewBox="0 0 20 20"
                    ...
                    <svg aria-hidden="true" class="fill-current dark:hidden" width="20" height="20" viewBox="0 0 20 20" fill="none"
